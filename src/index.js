...
const COMPUTER_RANDOM_NUMBER = MissionUtils.Random.pickUniqueNumbersInRange(1, 9, 3).join('');

export default function BaseballGame() {
    this.play = function (computerInputNumbers, userInputNumbers) {
        computerInputNumbers = COMPUTER_RANDOM_NUMBER;
...
console.log(COMPUTER_RANDOM_NUMBER)
